...
// оригінальні дані мали центр приблизно (0, 1, 18), а обертання (rotateFast)
// завжди відбувається навколо локального початку координат — тому без
// зсуву корабель оберталний не навколо власного центру, а навколо точки
// віддаленої на 18 одиниць по Z.
static const int COBRA_VERTICES = 12;

static const Point3D cobra_vertices[COBRA_VERTICES] = {
    {  32,  -1,  58}, // 0  ніс, правий верх
    { -32,  -1,  58}, // 1  ніс, лівий верх
    {   0,  25,   6}, // 2  купол кабіни
    { -120,  -4, -26}, // 3  ліве тіло, середа
    { 120,  -4, -26},  // 4  праве тіло, середа
    { -88,  15, -58},  // 5  лів задній верх
    { 88,   15, -58},  // 6  прав задній верх
    { 128,  -9, -58},  // 7  прав кінець крила
    { -128, -9, -58},  // 8  лів кінець крила
    {   0,  25, -58},  // 9  задній центр, верх
    { -32, -25, -58},  // 10 лів задній живіт
    { 32,  -25, -58},  // 11 прав задній живіт
};
